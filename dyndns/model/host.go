...
type Host struct {
	...
	Ip6Prefix      string    `form:"ip6prefix" validate:"omitempty,ipv6"`
	...
	TrackingMode   int       `form:"trackingmode"`
	TrackingHostID uint
...
func (h *Host) UpdateHost(updateHost *Host) (updateRecord bool) {
	...
	if h.Ip4 != updateHost.Ip4 || h.Ip6 != updateHost.Ip6 || h.Ttl != updateHost.Ttl {
		updateRecord = true
